...
# sales and spend as shown by many of the peaks in sales corresponding to a peak 
# in one of the spend amounts as shown in the 5th, 12th, 16th and 20th months. 
# The level of correlation will need further investigation.
...
# variance in sales is explained by the change in these variables. This is a 
# relatively high output for a linear model.
...
# 70% confident of their significance. The p-value of thexmas variable is 
# 0.00563, which means we are 99.437% confident of its significance. This level 
# would be satisfactory in the majority of situations. Finally the p-value for 
# the tv_spend and digital_spend are both below 0.001, giving them a confidence 
# level of above 99.9% which puts them well into the statistically significant 
# range.
...
# sales.
# In terms of absolute dollar amount, it contributes $1.947 for every extra 
# dollar spent.
...
# broken down into what percentage would have seen the ad once, twice, three 
#times, four times or five or more times. 
#
...
# this, it could be useful to include extra variables indicating the previous 
...
#Similar indicators could be used for expansion into new markets. Finally, price
# discounts could also influence sales. Variables indicating the lowest selling 
# price for each month either as a price or as a percentage discount could be 
# used to convey this to the model.